...
import { AnimationService } from 'src/app/service/core/animation.service';
...
export class MessageBubble {
  ...
  protected isAssistant: Signal<boolean> = computed(() => this.message().role === MessageRole.ASSISTANT);
